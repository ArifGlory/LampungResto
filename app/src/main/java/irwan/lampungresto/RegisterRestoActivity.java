...
import irwan.lampungresto.Kelas.Resto;
import irwan.lampungresto.Kelas.Utils;

public class RegisterRestoActivity extends AppCompatActivity {

    EditText fullName, emailId,
            password, confirmPassword,userPhone,etAlamat;
    TextView login;
    Button signUpButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(RegisterRestoActivity.this);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                i = new Intent(getApplicationContext(),LoginRestoActivity.class);
                startActivity(i);
            }
        });
    ...
    private void checkValidation() {
        ...
        if (getFullName.equals("") || getFullName.length() == 0
            ...
            customToast("Alamat harus diiisi");
            hidupkanKomponen();
        }
        //check valid email
        else if (!m.find()) {
        ...
        fAuth.createUserWithEmailAndPassword(email,passwordUser).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (!task.isSuccessful()){
                    ...
                    Toast.makeText(RegisterRestoActivity.this,"Proses Pendaftaran gagal"+task.getException().toString(),Toast.LENGTH_LONG).show();
                    ...
                    restoDaftarModel = new Resto(userID,
                    ...
                    ref = ref.child("resto");
                    ref.child(userID).setValue(restoDaftarModel);

                    Toast.makeText(RegisterRestoActivity.this,"Register Resto Succes ! Please go to Login page \n" +
